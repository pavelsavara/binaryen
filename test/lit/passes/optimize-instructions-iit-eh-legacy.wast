...
<<<<<<<< HEAD:test/lit/passes/optimize-instructions-iit-eh-old.wast
  ;; CHECK-NEXT:  (try $try
========
  ;; CHECK-NEXT:  (try
>>>>>>>> 54f9f7afa703ade4a34aa3291abbe237bb0cd8a4:test/lit/passes/optimize-instructions-iit-eh-legacy.wast
  ;; CHECK-NEXT:   (do
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:   (catch $e
  ;; CHECK-NEXT:    (throw $e
